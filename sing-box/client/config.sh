...
cat > "$SINGBOX_DIR/client-whitelist.json" <<EOF
{
  ...
  "route": {
    ...
    "rules": [
      // WHITELIST-START
      { "outbound": "proxy", "domain": ["domain:habr.com"] },
      { "outbound": "proxy", "domain": ["domain:voice.discord.gg"] },
      { "outbound": "proxy", "domain": ["domain:voice.discord.media"] },
      { "outbound": "proxy", "domain": ["domain:rtc.discord.com"] },
      { "outbound": "proxy", "domain": ["domain:discord-attachments-uploads-prd.storage.googleapis.com"] },
      { "outbound": "proxy", "domain": ["domain:discord.media"] },
      { "outbound": "proxy", "domain": ["domain:test.com"] },
      { "outbound": "proxy", "domain": ["domain:openai.com"] },
      { "outbound": "proxy", "domain": ["domain:chatgpt.com"] },
      { "outbound": "proxy", "domain": ["domain:discordcdn.com"] },
      { "outbound": "proxy", "domain": ["domain:discordapp.com"] },
      { "outbound": "proxy", "domain": ["domain:discord.gg"] },
      { "outbound": "proxy", "domain": ["domain:discord.com"] },
      { "outbound": "proxy", "domain": ["domain:ggpht.com"] },
      { "outbound": "proxy", "domain": ["domain:googlevideo.com"] },
      { "outbound": "proxy", "domain": ["domain:ytimg.com"] },
      { "outbound": "proxy", "domain": ["domain:youtu.be"] },
      { "outbound": "proxy", "domain": ["domain:youtube.com"] }
      // WHITELIST-END
      ,
      {
        "ip_is_private": true,
